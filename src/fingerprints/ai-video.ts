...
export const AI_VIDEO: Fingerprint[] = [
  ...
  },
  {
    ...
    signals: [{ type: 'request', pattern: /(^|\.)api\.pika\.art|pika\.art\/api/, weight: 0.95 }],
  },
  {
    id: 'kling',
    name: 'Kling AI',
    ...
    signals: [{ type: 'request', pattern: /[\w-]*\.?klingai\.com/, weight: 0.9 }],
  },
  {
    id: 'hedra',
    name: 'Hedra',
    category: 'ai-video',
    description: 'Character and avatar video',
    icon: 'hedra',
    website: 'https://hedra.com',
    signals: [{ type: 'request', pattern: /(^|\.)api\.hedra\.com/, weight: 0.95 }],
  },
  {
    id: 'descript',
    name: 'Descript',
    ...
    signals: [
      { type: 'request', pattern: /share\.descript\.com|(^|\.)api\.descript\.com/, weight: 0.9 },
      { type: 'dom', selector: 'iframe[src*="descript.com"]', weight: 0.9 },
    ],
  },
]
